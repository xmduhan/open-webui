...
router.include_router(pipelines.router, prefix="/api/v1/pipelines", tags=["pipelines"])
router.include_router(tasks.router, prefix="/api/v1/tasks", tags=["tasks"])
router.include_router(images.router, prefix="/api/v1/images", tags=["images"])

router.include_router(audio.router, prefix="/api/v1/audio", tags=["audio"])
router.include_router(retrieval.router, prefix="/api/v1/retrieval", tags=["retrieval"])

router.include_router(configs.router, prefix="/api/v1/configs", tags=["configs"])

router.include_router(auths.router, prefix="/api/v1/auths", tags=["auths"])
router.include_router(users.router, prefix="/api/v1/users", tags=["users"])


router.include_router(channels.router, prefix="/api/v1/channels", tags=["channels"])
router.include_router(chats.router, prefix="/api/v1/chats", tags=["chats"])
router.include_router(notes.router, prefix="/api/v1/notes", tags=["notes"])


router.include_router(models.router, prefix="/api/v1/models", tags=["models"])
router.include_router(knowledge.router, prefix="/api/v1/knowledge", tags=["knowledge"])
router.include_router(prompts.router, prefix="/api/v1/prompts", tags=["prompts"])
router.include_router(tools.router, prefix="/api/v1/tools", tags=["tools"])

router.include_router(memories.router, prefix="/api/v1/memories", tags=["memories"])
router.include_router(folders.router, prefix="/api/v1/folders", tags=["folders"])
router.include_router(groups.router, prefix="/api/v1/groups", tags=["groups"])
router.include_router(files.router, prefix="/api/v1/files", tags=["files"])
router.include_router(functions.router, prefix="/api/v1/functions", tags=["functions"])
router.include_router(
    evaluations.router, prefix="/api/v1/evaluations", tags=["evaluations"]
)
router.include_router(utils.router, prefix="/api/v1/utils", tags=["utils"])

# SCIM 2.0 API for identity management
if ENABLE_SCIM:
    router.include_router(scim.router, prefix="/api/v1/scim/v2", tags=["scim"])
